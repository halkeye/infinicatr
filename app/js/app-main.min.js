jQuery(document).ready(function() {
  "use strict";
  var template = jQuery('#carousel-entry-template').html();
  ...
  var morePhotosSuccess = function(data) {
    ...
    jQuery.each(data.photos.photo, function(idx,elm) {
      ...
      elm.photo_info_url = "http://www.flickr.com/photos/{user-id}/{photo-id}"
        .replace('{photo-id}', elm.id)
        .replace('{user-id}', elm.owner);
      var $div = $car.append(Mustache.render(template, { elm: elm }));
  ...
  var getMorePhotos = function(callback) {
    ...
    $.ajax('http://api.flickr.com/services/rest/', query);
  };
  /* Initial Fetch */
  getMorePhotos();
  var carFuncs = {
